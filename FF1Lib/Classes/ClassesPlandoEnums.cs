...
namespace FF1Lib
{
	...
	public enum BonusMalusActionPlando
	{
		None = 0,
		StrModUp10 = 1,
		StrModUp20 = 2,
		...
		WeaponAddAxes = 32,
		WeaponAddThief = 33,
		WeaponAddLegendary = 34,
		WeaponAddFighter = 35,
		ArmorAddShirts = 36,
		ArmorAddShields = 37,
		ArmorAddHelmGauntlet = 38,
		ArmorAddRedMage = 39,
		ArmorAddFighter = 40,
		SpcModPlus2 = 41,
		StartWithMPLvl1 = 42,
		...
		HunterDragon = 45,
		HunterHurtAll = 46,
		InnateResistMinor = 47,			//Used for the selected Resistances
		InnateResistMajor = 48,         //Used for the PEDTS Resistances
		InnateResistAll = 49,
		SpcGrowthImpMP = 50,
		PowerRMPromo = 51,
		PowerRM = 52,
		...
		ImprovedCatclaw = 58,
		DualWieldKnife = 59,
		StartWithGoldUp200 = 60,
		StartWithGoldUp400 = 61,
		StartWithGoldUp600 = 62,
		StartWithGoldUp800 = 63,
		StartWithGoldUp1500 = 64,
		StartWithGoldUp5000 = 65,
		StartWithGoldUp1400 = 66,
		StartWithGoldUp2000 = 67,
		StartWithGoldUp3000 = 68,
		StartWithGoldUp4000 = 69,
		StartWithGoldUp6000 = 70,
		...
		LateLockpicking = 98,
		InnateSpellsNuke = 99,
		InnateSpellsElemPlus = 100,
		InnateSpellsElem = 101,
		InnateSpellsClean = 102,
		InnateSpellsDoom = 103,
		InnateSpellsHeal = 104,
		InnateSpellsHealPlus = 105,
		InnateSpellsSelf = 106,
		InnateSpellsBuff = 107,
		InnateSpellsTele = 108,
		LearnLampRibbon = 109,
		LearnDarkEvade = 110,
		LearnSleepMDef = 111,
		LearnSlowAbsorb = 112,
