...
namespace FF1Lib
{
	public class Flags : IIncentiveFlags, IMapEditFlags, IScaleFlags, IFloorShuffleFlags
	{
		...
		#region League
		#region LeagueBonus
		public bool Add10Str { get; set; } = false;
		public bool? Add20Str { get; set; } = false;
		public bool? Add15Agi { get; set; } = false;
		public bool? Add20Agi { get; set; } = false;
		public bool? Add25Agi { get; set; } = false;
		public bool? Add10Vit { get; set; } = false;
		public bool? Add20Vit { get; set; } = false;
		public bool? Add5Luck { get; set; } = false;
		public bool? Add10Luck { get; set; } = false;
		public bool? Add20HP { get; set; } = false;
		public bool? Add40HP { get; set; } = false;
		public bool? Add10PerHit { get; set; } = false;
		public bool? Add20PerHit { get; set; } = false;
		public bool? EquipAxe { get; set; } = false;
		public bool? EquipShirt { get; set; } = false;
		...
		#endregion
		#region LeagueMalus
		public bool? Down10Str { get; set; } = false;
		public bool? Down20Str { get; set; } = false;
		public bool? Down10Agi { get; set; } = false;
		public bool? Down20Agi { get; set; } = false;
		public bool? Down10Vit { get; set; } = false;
		public bool? Down20Vit { get; set; } = false;
		public bool? Down5Luck { get; set; } = false;
		public bool? Down10Luck { get; set; } = false;
		public bool? Down15HP { get; set; } = false;
		public bool? Down30HP { get; set; } = false;
		public bool? BMHP { get; set; } = false;
		public bool? Down1Hitpercent { get; set; } = false;
		public bool? Down1Mdef { get; set; } = false;
		public bool? Nobrace { get; set; } = false;
		public bool? NoMasa { get; set; } = false;
		public bool? NoRibbon { get; set; } = false;
		public bool? NoProring { get; set; } = false;
		public bool? ThiefweaponsMalus { get; set; } = false;
		public bool? Down4MaxMP { get; set; } = false;
		public bool? NoSpell { get; set; } = false; //this one might need some added items to get the spell
		public bool? NoFiPromoArmor { get; set; } = false;
		public bool? PromoRMArmor { get; set; } = false;
		public bool? NoPromoSpells { get; set; } = false;
		public bool? LateLockpick { get; set; } = false;
		public bool? Down50GP { get; set; } = false;
		public bool? Down100GP { get; set; } = false;
		public bool? Down150GP { get; set; } = false;
		public bool? Down350GP { get; set; } = false;
		public bool? Down1100GP { get; set; } = false;
		public bool? Down4500gp { get; set; } = false;
		#endregion
